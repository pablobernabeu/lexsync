...
- **Spanish gender ('es_gender')** — 10185 words. A derivative of the 'es' corpus above, restricted to words with canonical Spanish gender endings (-a feminine, -o masculine; gerunds excluded) and tagged with a `gender` column. Used by the demonstration that reproduces the gender-assignment design of González Alonso et al. (2025). Grammatical gender is approximated by word ending, not looked up in a lexical database (the original used EsPal; Duchon et al., 2013).
...
- Cuetos, F., González-Nosti, M., Barbón, A., & Brysbaert, M. (2011). SUBTLEX-ESP. Psicológica, 32(2), 133-143.
