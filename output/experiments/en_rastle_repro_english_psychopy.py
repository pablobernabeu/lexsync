...
EVENTS = json.loads(r"""[{"type": "fixation", "text": "+", "frames": 30}, {"type": "text", "field": "prime", "frames": 3, "trigger": 20}, {"type": "mask", "text": "#####", "frames": 2}, {"type": "text", "field": "target", "frames": 48, "trigger": "@condition_trigger"}, {"type": "response", "keys": ["left", "right"], "timeout": 2.0}, {"type": "blank", "frames": 15}]""")
