...
Design: en_rastle_repro    Language: english
Conditions file: en_rastle_repro_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_rastle_repro_english_psychopy.csv")
