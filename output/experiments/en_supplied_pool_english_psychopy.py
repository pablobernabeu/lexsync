...
Design: en_supplied_pool    Language: english
Conditions file: en_supplied_pool_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_supplied_pool_english_psychopy.csv")
