...
EVENTS = json.loads(r"""[{"type": "fixation", "text": "+", "frames": 30}, {"type": "text", "field": "target", "frames": 48, "trigger": "@condition_trigger"}, {"type": "response", "keys": ["left", "right"], "timeout": 2.0}, {"type": "blank", "frames": 15}]""")
