...
Design: en_lexdec_wuggy    Language: english
Conditions file: en_lexdec_wuggy_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_lexdec_wuggy_english_psychopy.csv")
...
EVENTS = json.loads(r"""[{"type":"fixation","text":"+","ms":500},{"type":"text","field":"target","ms":800,"trigger":"@condition_trigger"},{"type":"response","keys":["left","right"],"timeout":2},{"type":"blank","ms":250}]""")
