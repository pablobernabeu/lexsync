...
Design: en_balanced_lists    Language: english
Conditions file: en_balanced_lists_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_balanced_lists_english_psychopy.csv")
