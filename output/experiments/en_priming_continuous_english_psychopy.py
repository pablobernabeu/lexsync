...
Design: en_priming_continuous    Language: english
Conditions file: en_priming_continuous_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_priming_continuous_english_psychopy.csv")
...
EVENTS = json.loads(r"""[{"type":"fixation","text":"+","ms":500},{"type":"text","field":"prime","ms":50,"trigger":20},{"type":"mask","text":"#####","ms":33},{"type":"text","field":"target","ms":800,"trigger":"@condition_trigger"},{"type":"response","keys":["left","right"],"timeout":2},{"type":"blank","ms":250}]""")
