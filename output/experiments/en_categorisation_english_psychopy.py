...
Design: en_categorisation    Language: english
Conditions file: en_categorisation_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_categorisation_english_psychopy.csv")
...
EVENTS = json.loads(r"""[{"type":"fixation","text":"+","ms":500},{"type":"text","field":"category","ms":750},{"type":"text","field":"target","ms":800,"trigger":"@condition_trigger"},{"type":"response","keys":["f","j"],"timeout":2.5},{"type":"blank","ms":250}]""")
