...
Design: es_gender_repro    Language: spanish
Conditions file: es_gender_repro_spanish_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "es_gender_repro_spanish_psychopy.csv")
