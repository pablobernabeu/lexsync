...
Design: zh_freqcontrast    Language: chinese
Conditions file: zh_freqcontrast_chinese_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "zh_freqcontrast_chinese_psychopy.csv")
