...
Design: en_andrews_repro    Language: english
Conditions file: en_andrews_repro_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_andrews_repro_english_psychopy.csv")
