...
Design: en_freqcontrast    Language: english
Conditions file: en_freqcontrast_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_freqcontrast_english_psychopy.csv")
