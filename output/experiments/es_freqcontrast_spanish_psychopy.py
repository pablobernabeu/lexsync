...
Design: es_freqcontrast    Language: spanish
Conditions file: es_freqcontrast_spanish_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "es_freqcontrast_spanish_psychopy.csv")
