...
Design: en_spr    Language: english
Conditions file: en_spr_english_psychopy.csv
...
CONDITIONS_FILE = os.path.join(HERE, "en_spr_english_psychopy.csv")
...
EVENTS = json.loads(r"""[{"type":"fixation","text":"+","ms":500},{"type":"region","field":"sentence","sep":"|","key":"space","crit_trigger":"@condition_trigger"},{"type":"question","field":"question","keys":["f","j"],"timeout":5},{"type":"blank","ms":250}]""")
