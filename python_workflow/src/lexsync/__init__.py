...
from .querying import (add_bigram_frequency, add_neighbourhood, build_pool,
                       count_syllables, load_items, load_lexicon, merge_norms)
...
__all__ = [
    "load_lexicon", "load_items", "add_neighbourhood", "add_bigram_frequency",
    "count_syllables", "merge_norms", "build_pool", "match_stimuli",
    "resample_stimuli", "make_pseudoword", "generate_pseudowords", "build_lexdec_stimuli",
